...
from archs.amt.blocks.raft import (
    coords_grid,
    SmallUpdateBlock, BidirCorrBlock
)
from archs.amt.blocks.feat_enc import (
    SmallEncoder
)
...
from archs.amt.blocks.multi_flow import (
    multi_flow_combine,
    MultiFlowDecoder
)
...
class Model(nn.Module):
    ...
    def inference(self, img0, img1, embt):
        return self.forward(img0=img0, img1=img1, embt=embt)
